...
Efficient (it should be at least) reference-free quality assessment for hyperspectral pansharpening, optimized for large images using Dask.

**This code has been mainly tested on PRISMA images, based on my own projects. If you encounter any kind of issues, just open an Issue and we'll work it out! 
I would like this repo to be used by as many users as possible!**

![alt text](repoinanutshell.png)
(This image was generated by nano banana and well... I kinda like it a lot lol 😂)
...
Contributions are welcome! Please submit issues and pull requests on GitHub. **I used to work on the original code a while ago (and never actually thoroughly tested it), so if you notice anything wrong, let me know asap :D**
